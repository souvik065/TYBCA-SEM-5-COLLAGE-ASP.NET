<%@ Page Title="" Language="VB" MasterPageFile="~/OnlineTutorial.master" AutoEventWireup="false" CodeFile="ContacUs.aspx.vb" Inherits="ContacUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="flex items-center justify-center bg-black">
        <div>
            <div class="border border-black rounded bg-black py-10 px-10">
