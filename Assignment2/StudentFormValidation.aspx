        ...
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtName" runat="server" CssClass="border"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="border"></asp:TextBox>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email" ForeColor="Red" ControlToValidate="txtEmail" Display="Dynamic" SetFocusOnError="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">
                    ...
                    <td>
                        <asp:TextBox ID="txtMobileNo" runat="server" CssClass="border"></asp:TextBox>
                        ...
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="MobileNo must be Digit" ControlToValidate="txtMobileNo" ForeColor="Red"  ></asp:CustomValidator>
                        <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="MobileNo mst be in 10 Digit" ControlToValidate="txtMobileNo" ForeColor="Red"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="txtAge" runat="server" CssClass="border"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" CssClass="border"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPassword" runat="server" CssClass="border"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCnfPassword" runat="server" CssClass="border"></asp:TextBox>
                         ...
                         <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password is not same" ForeColor="Red" ControlToValidate="txtPassword"></asp:CompareValidator>
                    </td>
